...
angular.module('flowableModeler')
  .controller('ProcessesCtrl', ['$rootScope', '$scope', '$translate', '$http', '$timeout','$location', '$modal', function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal) {
      ...
      $scope.mergeProcess = function () {
          _internalCreateModal({
              template: 'views/popup/process-merge.html?version=' + Date.now()
          }, $modal, $scope);
      };
...
angular.module('flowableModeler')
    .controller('MergeProcessModelCtrl', ['$rootScope', '$scope', '$http', 'Upload', '$location', function ($rootScope, $scope, $http, Upload, $location) {
