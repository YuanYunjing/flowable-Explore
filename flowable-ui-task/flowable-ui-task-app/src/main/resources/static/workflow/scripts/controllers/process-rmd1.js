...
angular.module('flowableApp')
  .controller('RmdProcessController1', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', '$modal', '$routeParams',
...
angular.module('flowableApp')
    .controller('RmdProcessDetailController1', ['$rootScope', '$scope', '$translate', '$http', '$timeout','$location', '$route', '$modal', '$routeParams', '$popover', 'appResourceRoot', 'TaskService', 'RelatedContentService',
    ...
    $scope.showProcessDiagram = function() {
     ...
     $scope.selectProcess2Merge = function(aid1,aid2) {
...
//                console.log(data)
            ...
            $timeout(function () {
                ...
                console.log("前面都沒有執行，來執行這裏了嗎？歡迎呀")
                console.log(jQuery("#bpmnModel").attr('data-model-id'))
                console.log($scope.model.processInstance.id)
                // in case we want to show a historic model, include additional attribute on the div
                if ($scope.model.processInstance.ended) {
