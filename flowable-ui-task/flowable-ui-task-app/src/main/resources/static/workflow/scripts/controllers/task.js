...
angular.module('flowableApp')
  .controller('TaskDetailController', ['$rootScope', 'ProcessService','$scope', '$translate', '$http','$location', '$routeParams', 'appResourceRoot', 'CommentService', 'TaskService', 'FormService', 'RelatedContentService', '$timeout', '$modal', '$popover',
        function ($rootScope,ProcessService, $scope, $translate, $http, $location, $routeParams, appResourceRoot, CommentService, TaskService, FormService, RelatedContentService, $timeout, $modal, $popover) {
    ...
    //$scope.gaol=$scope.model.task.processInstanceId;
    //ProcessService.name1=$scope.model.task.formKey;
    ...
    $scope.resetModel = function() {
        // Reset tabs
        ProcessService.name1=$scope.model.task.processInstanceId;
        $scope.taskTabs = [];
