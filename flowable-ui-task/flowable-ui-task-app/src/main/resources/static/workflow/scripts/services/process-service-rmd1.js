...
angular.module('flowableApp').service('ProcessService', ['$http', '$q', '$rootScope', 'RelatedContentService',
    function ($http, $q, $rootScope, RelatedContentService) {
        ...
        // 获得推荐流程定义列表
        this.getRMDProcessDefinitions = function(processId) {
            var url = FLOWABLE.CONFIG.contextRoot + '/app/rest/rmd-process-definitions?def1_id='+processId+'&def2_id='+processId;
            return httpAsPromise(
                {
                    method: 'GET',
                    url: url
