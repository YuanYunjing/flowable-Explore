...
FLOWABLE.TOOLBAR_CONFIG = {
    "items" : [
        ...
        {
            "type" : "button",
            "title" : "TOOLBAR.ACTION.EVOLUTION",
            "cssClass" : "icon icon-evolution",
            "action": "FLOWABLE.TOOLBAR.ACTIONS.evolutionProcess",
        },
        {
            "type" : "button",
            "title" : "TOOLBAR.ACTION.RUN",
            "cssClass" : "icon icon-run",
            "action": "FLOWABLE.TOOLBAR.ACTIONS.runProIns",
        },
        {
            "type" : "separator",
            "title" : "",
