  ...
  // Initialize routes
   ...
   $provide.value('appResourceRoot', appResourceRoot);
    ...
    $routeProvider
        ...
        .when('/rmdProcessDefinitions/:id', {
            templateUrl: appResourceRoot + 'views/modal/process-instance-graphical-main.html',
            controller: 'ShowProcessInstanceDiagramCtrl'
        })
        .when('/model/:processInstanceId', {
            templateUrl: appResourceRoot + 'editor-app/editor.html',
            controller: 'EditorController'
        })
        // .when('/services-rmd', {
        //     templateUrl: appResourceRoot + 'views/services-rmd.html',
        //     controller: 'RmdServesController'
        // })

       .when('/rmdProcessDefinitions99', {
               templateUrl: appResourceRoot + 'views/processes-rmd.html',
               controller: 'RmdProcessesController'
       })
        .when('/rmdProcessDefinitions1', {
            templateUrl: appResourceRoot + 'views/processes-rmd1.html',
            controller: 'RmdProcessesController1'
        })
        .when('/rmdProcessDefinitions2', {
            templateUrl: appResourceRoot + 'views/processes-rmd2.html',
            controller: 'RmdProcessesController2'
        })
        // .when('/apps/:appDefinitionKey/processes', {
        //     templateUrl: appResourceRoot + 'views/processes.html',
        //     controller: 'ProcessesController'
        ...
        .when('/process-definition/:definitionId', {
            templateUrl: 'views/process-detail-rmd.html',
            controller: 'RmdProcessDetailController',
            reloadOnSearch: true
        })
    ...
    .run(['$rootScope', '$routeParams', '$timeout', '$translate', '$location', '$http', '$window', 'appResourceRoot', 'AppDefinitionService', 'ProcessService', 'CaseService',
        ...
        $rootScope.setMainPage = function(mainPage) {
            ...
            $rootScope.setMainPage1 = function(mainPage) {
                $rootScope.mainPage = mainPage;
