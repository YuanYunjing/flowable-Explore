    ...
    .controller('FormBuilderController', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', '$modal', '$routeParams', '$popover', 'FormBuilderService',
        function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal, $routeParams, $popover, FormBuilderService) {
            ...
            $scope.palletteElements = [
                {'type': 'data', 'title': '健康监控数据服务', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'liuchengshitu', 'title': '流程视图', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'button', 'title': '流程服务', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'heathcard', 'title': '健康档案数据服务', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'video', 'title': '视频展示服务', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'pic', 'title': '图片', 'icon': 'images/form-builder/xueya.png', 'width': 1},
                {'type': 'text', 'title': $translate.instant('FORM-BUILDER.PALLETTE.TEXT'), 'icon': 'images/form-builder/textfield-icon.png', 'width': 1},
                {'type': '   ', 'title': $translate.instant('FORM-BUILDER.PALLETTE.PASSWORD'), 'icon': 'images/form-builder/password-icon.png', 'width': 1},
