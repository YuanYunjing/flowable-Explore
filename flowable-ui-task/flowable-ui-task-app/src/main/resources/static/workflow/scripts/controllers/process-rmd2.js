...
angular.module('flowableApp')
  .controller('RmdProcessController2', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', '$modal', '$routeParams',
...
angular.module('flowableApp')
    .controller('RmdProcessDetailController2', ['$rootScope', '$scope', '$translate', '$http', '$timeout','$location', '$route', '$modal', '$routeParams', '$popover', 'appResourceRoot', 'TaskService', 'RelatedContentService',
