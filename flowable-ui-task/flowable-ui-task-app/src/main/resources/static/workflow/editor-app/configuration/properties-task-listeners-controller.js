...
angular.module('flowableApp').controller('FlowableTaskListenersCtrl',
...
angular.module('flowableApp').controller('FlowableTaskListenersPopupCtrl',
    ['$scope', '$q', '$translate', '$timeout', function ($scope, $q, $translate, $timeout) {
        ...
        //         className: '',
        //         expression: '',
        //         delegateExpression: '${testHandler}'
        //     };
        //     $scope.taskListeners.push(newListener);
        //
        //     $scope.selectedListener=$scope.taskListeners[0];
        //
        //     if($scope.selectedListener)
        //     if ($scope.selectedListener.fields == undefined) {
        //         $scope.selectedListener.fields = [];
        ...
        //         stringValue: '',
        //         expression: '',
        //         string: 'http://39.96.139.30:8081/v1/specialist/query/catalyst'
        //     };
        //     var newField2 = {
        //         name: 'keyword',
        //         implementation: '',
        ...
        //         string: 'catalyst',
        //     };
        //     $scope.selectedListener.fields.push(newField1);
        //     $scope.selectedListener.fields.push(newField1);
        //
        //     // $scope.selectedListener.fields.push(newField2);
        //     // $scope.selectedListener.fields.push(newField2);
        //
        //     // $scope.updatePropertyInModel($scope.property);
