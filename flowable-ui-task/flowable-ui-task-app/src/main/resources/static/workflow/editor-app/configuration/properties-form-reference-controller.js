...
angular.module('flowableApp').controller('FlowableFormReferenceDisplayCtrl',
...
angular.module('flowableApp').controller('FlowableFormReferenceCtrl',
    [ '$scope', '$modal', '$http', function($scope, $modal, $http) {
...
angular.module('flowableApp').controller('FlowableFormReferencePopupCtrl',
