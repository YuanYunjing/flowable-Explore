...
angular.module('flowableApp').controller('FlowableCaseReferenceCtrl',
...
angular.module('flowableApp').controller('FlowableCaseReferencePopupCtrl', [ '$scope', '$http', 'editorManager', function($scope, $http, editorManager) {
