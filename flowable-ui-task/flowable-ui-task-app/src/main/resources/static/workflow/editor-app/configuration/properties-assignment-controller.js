...
angular.module('flowableApp').controller('FlowableAssignmentCtrl', [ '$scope', '$modal', function($scope, $modal) {
...
angular.module('flowableApp').controller('FlowableAssignmentPopupCtrl',
