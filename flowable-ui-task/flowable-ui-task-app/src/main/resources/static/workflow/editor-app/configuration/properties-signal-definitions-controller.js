...
angular.module('flowableApp').controller('FlowableSignalDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('flowableApp').controller('FlowableSignalDefinitionsPopupCtrl',
