...
angular.module('flowableApp').controller('FlowableMessageDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('flowableApp').controller('FlowableMessageDefinitionsPopupCtrl',
