 ...
 */
angular.module('flowableApp').controller('FlowablePlanItemLifecycleListenersCtrl',
...
angular.module('flowableApp').controller('FlowablePlanItemLifecycleListenersPopupCtrl',
