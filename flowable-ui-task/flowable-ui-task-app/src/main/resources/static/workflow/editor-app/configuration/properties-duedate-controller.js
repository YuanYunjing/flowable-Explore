...
angular.module('flowableApp').controller('BpmnEditorDueDateCtrl', [ '$scope', '$modal', function($scope, $modal) {
...
angular.module('flowableApp').controller('BpmnEditorDueDatePopupCtrl',
