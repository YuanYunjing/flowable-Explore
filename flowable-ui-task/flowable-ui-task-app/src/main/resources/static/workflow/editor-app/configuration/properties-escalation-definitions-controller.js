...
angular.module('flowableApp').controller('FlowableEscalationDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('flowableApp').controller('FlowableEscalationDefinitionsPopupCtrl',
