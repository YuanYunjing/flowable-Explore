...
angular.module('flowableApp').controller('FlowableConditionExpressionCtrl', [ '$scope', '$modal', function($scope, $modal) {
...
angular.module('flowableApp').controller('FlowableConditionExpressionPopupCtrl',
