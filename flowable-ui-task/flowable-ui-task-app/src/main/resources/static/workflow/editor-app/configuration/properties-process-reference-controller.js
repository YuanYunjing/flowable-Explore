...
angular.module('flowableApp').controller('FlowableProcessReferenceCtrl',
...
angular.module('flowableApp').controller('FlowableProcessReferencePopupCtrl', [ '$scope', '$http', function($scope, $http) {
