...
angular.module('flowableApp').controller('FlowableUserInputFormPropertiesCtrl',
    ['$scope', '$modal', '$timeout', '$translate', function ($scope, $modal, $timeout, $translate) {

        // Config for the modal window
        var opts = {
            template: 'editor-app/configuration/properties/user-input-form-popup.html?version=' + Date.now(),
            scope: $scope
        };
...
angular.module('flowableApp').controller('FlowableUserInputFormPropertiesPopupCtrl',
