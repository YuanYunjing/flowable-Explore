...
angular.module('flowableApp').controller('FlowableStringPropertyCtrl', [ '$scope', function ($scope) {
...
angular.module('flowableApp').controller('FlowableBooleanPropertyCtrl', ['$scope', function ($scope) {
...
angular.module('flowableApp').controller('FlowableTextPropertyCtrl', [ '$scope', '$modal', '$timeout', function($scope, $modal, $timeout) {
...
angular.module('flowableApp').controller('FlowableTextPropertyPopupCtrl', ['$scope', function($scope) {
