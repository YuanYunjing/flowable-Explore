...
angular.module('flowableApp').controller('FlowableDecisionTableReferenceCtrl',
...
angular.module('flowableApp').controller('FlowableDecisionTableReferencePopupCtrl', ['$rootScope', '$scope', '$http', '$location', 'editorManager',
