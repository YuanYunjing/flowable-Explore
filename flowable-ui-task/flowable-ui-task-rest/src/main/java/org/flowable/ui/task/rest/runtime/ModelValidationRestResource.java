...
import org.flowable.ui.task.validation.LocalProcessValidatorFactory;
        ...
        if (body != null && body.has("stencilset")) {
            ...
            if (stencilset.has("namespace")) {
                ...
                if (namespace.endsWith("bpmn2.0#")) {
                    ...
                    ProcessValidator validator = new LocalProcessValidatorFactory().createDefaultProcessValidator();
