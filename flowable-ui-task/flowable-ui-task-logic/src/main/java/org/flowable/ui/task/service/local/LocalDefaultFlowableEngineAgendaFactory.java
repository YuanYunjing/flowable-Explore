...
public class LocalDefaultFlowableEngineAgendaFactory extends DefaultFlowableEngineAgendaFactory {

    @Override
    public FlowableEngineAgenda createAgenda(CommandContext commandContext) {
        return new LocalDefaultFlowableEngineAgenda(commandContext);
    }
}
